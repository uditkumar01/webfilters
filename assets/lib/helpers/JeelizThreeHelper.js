...
const JeelizThreeHelper = (function () {
  ...
  const that = {
    ...
    update_camera: function (threeCamera) {
      ...
      console.debug('INFO in JeelizThreeHelper - update_camera(): Estimated vertical video FoV is', fov);
      ...
      threeCamera.fov = fov;
      console.debug('INFO in JeelizThreeHelper.update_camera(): camera vertical estimated FoV is', fov, 'deg');
