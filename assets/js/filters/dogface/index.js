function dogfaceFilter() {
  let DOG_THREECAMERA = null;
  let ANON_ISDETECTED = false;
  ...
  function apply_filter() {
    ...
    tempImage.src = getExtensionUrl('assets/images/texture_pink.jpg');
  ...
  function init_threeScene(spec) {
    ...
    loaderEars.load(
      getExtensionUrl('assets/js/filters/dogface/models/dog_ears.json'),
      function (geometry) {
        const mat = new THREE.FlexMaterial({
          map: new THREE.TextureLoader().load(getExtensionUrl('assets/js/filters/dogface/models/texture_ears.jpg')),
          flexMap: new THREE.TextureLoader().load(getExtensionUrl('assets/js/filters/dogface/models/flex_ears_256.jpg')),
          alphaMap: new THREE.TextureLoader().load(getExtensionUrl('assets/js/filters/dogface/models/alpha_ears_256.jpg')),
          transparent: true,
          opacity: 1,
          bumpMap: new THREE.TextureLoader().load(getExtensionUrl('assets/js/filters/dogface/models/normal_ears.jpg')),
          bumpScale: 0.0075,
          shininess: 1.5,
          specular: 0xffffff,
        });
    ...
    loaderNose.load(
      getExtensionUrl('assets/js/filters/dogface/models/dog_nose.json'),
      function (geometry) {
        const mat = new THREE.MeshPhongMaterial({
          map: new THREE.TextureLoader().load(getExtensionUrl('assets/js/filters/dogface/models/texture_nose.jpg')),
          shininess: 1.5,
          specular: 0xffffff,
          bumpMap: new THREE.TextureLoader().load(getExtensionUrl('assets/js/filters/dogface/models/normal_nose.jpg')),
          bumpScale: 0.005
        });
    ...
    loaderTongue.load(
      getExtensionUrl('assets/js/filters/dogface/models/dog_tongue.json'),
      function (geometry) {
        geometry.computeMorphNormals();
        const mat = new THREE.FlexMaterial({
          map: new THREE.TextureLoader().load(getExtensionUrl('assets/js/filters/dogface/models/dog_tongue.jpg')),
          flexMap: new THREE.TextureLoader().load(getExtensionUrl('assets/js/filters/dogface/models/flex_tongue_256.png')),
          alphaMap: new THREE.TextureLoader().load(getExtensionUrl('assets/js/filters/dogface/models/tongue_alpha_256.jpg')),
          transparent: true,
          morphTargets: true,
          opacity: 1
        });
    ...
    // CREATE THE CAMERA
    DOG_THREECAMERA = JeelizThreeHelper.create_camera();
  ...
  function init_dogfaceFilter() {
    JEELIZFACEFILTER.init({
      ...
      callbackTrack: function (detectState) {
        ANON_ISDETECTED = JeelizThreeHelper.get_isDetected();
        ...
        JeelizThreeHelper.render(detectState, DOG_THREECAMERA);
      } // end callbackTrack()
